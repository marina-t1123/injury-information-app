    ...
    <section class="text-gray-600 body-font relative">
        <div class="container px-5 py-10 mx-auto">
            ...
            <div class="lg:w-1/2 md:w-2/3 mx-auto">
                ...
                <form method="post" action="{{ route('user.medical-history.store', ['athlete_id' => $athlete->id ]) }}">
                    @csrf
                    <div class="-m-2">
                        <!-- 受傷日 -->
                        ...
                        <div class="p-2 w-3/4 mx-auto">
                            ...
                            <input type="radio" id="hospital_visit" name="hospital_visit" value="0" >なし
                            <input type="radio" id="hospital_visit" name="hospital_visit" value="1" >あり
                            </div>
                        </div>
                        <!-- 診断名 -->
                        <div class="p-2 w-3/4 mx-auto">
