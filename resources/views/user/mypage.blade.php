                    ...
                    <div class="xl:w-1/3 md:w-1/2 w-11/12 p-4 mx-auto">
                        <div class="bg-white border border-gray-200 p-6 rounded-lg min-w-500 shadow">
                            ...
                            <div class="athlete_menu">
                                <!-- 既往歴 -->
                                <a href="{{ route('user.medical-history.show.menu', ['athlete_id' => $athlete->id ])}}" class="">
                                ...
                                <!-- 問診票・カルテ詳細 -->
                                <a href="{{ route('user.medical-questionnaire.show.menu', ['athlete_id' => $athlete->id ])}}">
                                ...
                                <!-- 選手設定 -->
                                <a href="{{ route('user.athlete.show.setting', [ 'athlete_id' => $athlete->id ]) }}">
                                    <button class="flex items-center mt-auto mb-1 text-white bg-gray-400 border-0 py-2 px-4 w-full focus:outline-none hover:bg-gray-500 rounded">選手設定
                                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-auto" viewBox="0 0 24 24">
                                        <path d="M5 12h14M12 5l7 7-7 7"></path>
                                        </svg>
                                    </button>
