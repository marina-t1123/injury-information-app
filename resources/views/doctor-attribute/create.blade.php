    ...
    <section class="text-gray-600 body-font relative">
        <div class="container px-5 py-10 mx-auto">
            ...
            <div class="lg:w-1/2 md:w-2/3 mx-auto">
                ...
                <form method="post" action="{{ route('doctor.doctor-attribute.store', ['id' => $doctor->id ]) }}">
                    @csrf
                    <div class="-m-2">
                        <!-- 名前 -->
                        ...
                        <div class="p-2 w-3/4 mx-auto">
                            ...
                            <input type="text" id="hospital_name" name="hospital_name" value="{{ old('hospital_name') }}" class="w-full bg-white bg-opacity-50 rounded border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                            </div>
                        </div>
                        <!-- 電話番号 -->
                        <div class="p-2 w-3/4 mx-auto">
