    ...
    <section class="text-gray-600 body-font relative">
        <div class="container px-5 py-10 mx-auto">
            ...
            <div class="lg:w-1/2 md:w-2/3 mx-auto">
                ...
                <form method="post" action="{{ route('user.medical-record.update', ['medical_record_id' => $athlete->medicalQuestionnaires->medicalRecord->id ]) }}" enctype="multipart/form-data">
                    @csrf
                    <div class="-m-2">
                        <!-- 診察日 -->
                        <div class="p-2 w-3/4 mx-auto">
                            ...
                            <input type="date" id="hospital_day" name="hospital_day" value="{{ $athlete->medicalQuestionnaires->medicalRecord->hospital_day }}" class="w-full bg-white bg-opacity-50 rounded border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                            </div>
                        </div>
                        <!-- 担当医 -->
                        <div class="p-2 w-3/4 mx-auto">
                            ...
                            <input type="text" id="attending_physician" name="attending_physician" value="{{ $athlete->medicalQuestionnaires->medicalQuestionnaire->attending_physician }}" class="w-full bg-white bg-opacity-50 rounded border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                            </div>
                        </div>
                        <!-- 診察内容 -->
                        <div class="p-2 w-3/4 mx-auto">
                        ...
                        <div class="p-2 w-3/4 mx-auto">
                            <div class="relative">
                                ...
                                <input type="text" name="swelling" id="swelling" class="w-full bg-white bg-opacity-50 rounded border border-gray-300 focus:border-blue-500 focus:bg-white focus:ring-2 focus:ring-blue-200 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out">{{ $medicalQuestionnaire->swelling }}</input>
                            </div>
                        </div>
                        <!-- 今後の方針 -->
                        <div class="p-2 w-3/4 mx-auto">
                        ...
                        <div class="p-2 w-3/4 mx-auto">
                            <div class="relative">
                                <p>現在登録している画像</p>
                                <x-image :imageFileName="$athlete->medicalQuestionnaires->medicalRecord->medical_image" type="medical_image" />
                                <form >
                            </div>
                        </div>
                        <!-- 画像 -->
                        <div class="p-2 w-3/4 mx-auto">
                            <div class="relative">
                                ...
                                <input type="file" id="files" accept="image/png,image/jpeg,image/jpg" name="files[][medical_image]" multiple>
                            </div>
                        </div>
                        <!-- ボタン -->
